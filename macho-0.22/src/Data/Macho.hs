...
data CPU_SUBTYPE
    ...
    | CPU_SUBTYPE_X86_64_OTHER Word32
...
mach_cpusubtype CPU_TYPE_X86_64 other  = CPU_SUBTYPE_X86_64_OTHER other
...
parseMacho b =
    ...
    in Macho header commands sizeofcmds
...
sectionType flags = case flags .&. 0x000000ff of
    ...
    0x12 -> S_LAZY_DYLIB_SYMBOL_POINTERS
    0x13 -> S_LAZY_DYLIB_SYMBOL_POINTERS
    other -> error $ "unknown section type: " <> (show other)
